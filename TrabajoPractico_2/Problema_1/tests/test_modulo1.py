...
from modulos.cola_prioridad import proximo_paciente
from modulos.cola_prioridad import pacientes_pendientes
...
#chat 
reiniciar()
inserta_paciente("Ana", 1)
inserta_paciente("Juan", 3)
inserta_paciente("Luis", 2)
assert proximo_paciente() == "Ana"
assert pacientes_pendientes() == 3
assert atender_paciente() == "Ana"
assert atender_paciente() == "Luis"
...
